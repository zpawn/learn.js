...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_ArticleList_jsx__ = __webpack_require__(27);




var article = {
    title: 'Yoda, to Luke Skywalker',
    text: 'Size matters not. Look at me. Judge me by my size, do you? Hmm? No. And well you should not. For my ally is the Force, and a powerful ally it is.',
    author: 'Yoda'
};

__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_ArticleList_jsx__["a" /* ArticleList */], { title: article.title, text: article.text, author: article.author }), document.getElementById('article'));
